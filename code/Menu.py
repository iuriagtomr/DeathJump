...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(50, "Death", C_ORANGE, ((WINDOW_WIDTH / 2), 70))
            self.menu_text(50, "Jump", C_ORANGE, ((WINDOW_WIDTH / 2), 120))
            self.menu_text(18, "Pressione ENTER", C_WHITE, ((WINDOW_WIDTH / 2), 170))
            self.menu_text(18, "Pressione ESPAÇO para pular", C_WHITE, ((WINDOW_WIDTH / 2), 300))
